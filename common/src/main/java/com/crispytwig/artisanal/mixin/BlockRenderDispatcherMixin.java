...
import com.crispytwig.artisanal.client.renderer.FacadeModel;
...
public class BlockRenderDispatcherMixin {
    ...
    private BakedModel artisanal$facadeModel(BlockRenderDispatcher dispatcher, BlockState modelState, Operation<BakedModel> original, @Local(argsOnly = true) BlockPos pos) {
        return FacadeModel.wrap(original.call(dispatcher, modelState), modelState, pos);
    }
}
