package com.crispytwig.bbb.common.data;
...
public final class LayerData {
    ...
    public static void generate(Map<ResourceLocation, Block> layers, Map<ResourceLocation, ResourceLocation> parents) {
        BuildingButBetterPack.INSTANCE.clear(PackType.SERVER_DATA);
    ...
    private static void write(String namespace, String path, JsonObject json) {
        BuildingButBetterPack.INSTANCE.add(PackType.SERVER_DATA, ResourceLocation.fromNamespaceAndPath(namespace, path + ".json"), json);
    }
