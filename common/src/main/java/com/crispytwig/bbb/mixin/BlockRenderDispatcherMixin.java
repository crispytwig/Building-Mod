...
public class BlockRenderDispatcherMixin {
    ...
    private BakedModel bbb$facadeModel(BlockRenderDispatcher dispatcher, BlockState modelState, Operation<BakedModel> original, @Local(argsOnly = true) BlockPos pos) {
